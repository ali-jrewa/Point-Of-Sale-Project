            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="{{ route('manager.category.index') }}" class="nav-link @if (Request::segment(2) == 'category') active @endif"> <i class="nav-icon fa fa-cube"></i>
                                <p>Category</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('manager.product.index') }}" class="nav-link @if (Request::segment(2) == 'product') active @endif"> <i class="nav-icon fa fa-cubes"></i>
                                <p>Products</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('manager.customer.index') }}" class="nav-link @if (Request::segment(2) == 'customer') active @endif"> <i class="nav-icon fa fa-id-card"></i>
                                <p>Customer</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('manager.supplier.index') }}" class="nav-link @if (Request::segment(2) == 'supplier') active @endif"> <i class="nav-icon fa fa-truck"></i>
                                <p>Suppliers</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item"> <a href="{{ route('manager.expense-category.index') }}" class="nav-link @if (Request::segment(2) == 'expense-category') active @endif"> <i class="nav-icon fa fa-sitemap"></i>
                                <p>Expenses Category</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('manager.expense.index') }}" class="nav-link @if (Request::segment(2) == 'expense') active @endif"> <i class="nav-icon fas fa-file-invoice-dollar"></i>
                                <p>Expenses</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('manager.purchase.index') }}" class="nav-link @if (Request::segment(2) == 'purchase') active @endif"> <i class="nav-icon fas fa-file-invoice-dollar"></i>
                                <p>Purchase</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('manager.sale.index') }}" class="nav-link @if (Request::segment(2) == 'sale') active @endif"> <i class="nav-icon fa fa-cart-plus"></i>
                                <p>Sales List</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('manager.payment.index') }}" class="nav-link @if (Request::segment(2) == 'payment') active @endif""> <i class="nav-icon fa fa-dollar"></i>
                                <p>Payments</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item"> <a href="{{ route('manager.account.index') }}" class="nav-link @if (Request::segment(2) == 'account') active @endif"> <i class="nav-icon fa fa-user"></i>
                                <p>My Account</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item active"> <a href="{{ url('cashier/dashboard') }}" class="nav-link"> <i class="nav-icon bi bi-palette"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>

                        <li class="nav-item"> <a href="{{ route('cashier.sale.index') }}" class="nav-link @if (Request::segment(2) == 'sale') active @endif"> <i class="nav-icon fa fa-dollar"></i>
                                <p>Sales List</p>
                            </a>
                        </li>

                         <li class="nav-item"> <a href="{{ route('cashier.payment.index') }}" class="nav-link @if (Request::segment(2) == 'payment') active @endif"> <i class="nav-icon fa fa-dollar"></i>
                                <p>Payments</p>
                            </a>
                        </li>
